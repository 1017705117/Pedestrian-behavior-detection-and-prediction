...
tf.app.flags.DEFINE_integer('max_iters', 15000, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 4000, "Step size for reducing the learning rate, currently only support one step")
